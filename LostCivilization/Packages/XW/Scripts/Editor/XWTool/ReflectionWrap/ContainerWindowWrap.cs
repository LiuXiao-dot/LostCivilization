...
{
    /// <summary>
    /// Unity中ContainerWindow的反射对象
    /// EidtorWindow的最外面一层
    /// </summary>
    public static class ContainerWindowWrap
    {
        ...
        public static object GetMainContainerWindow()
        {
            FieldInfo finfo =
                ContainerWindowType.GetField("s_AllWindows", BindingFlags.Static | BindingFlags.NonPublic);
